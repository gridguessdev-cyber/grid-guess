...
CREATE TABLE IF NOT EXISTS "public"."levels" (
    ...
    "squareSize" real DEFAULT '20'::real NOT NULL,
    "horizontalShift" real DEFAULT '0'::real NOT NULL,
    "verticalShift" real DEFAULT '0'::real NOT NULL,
...
ALTER TABLE ONLY "public"."levels"
    ADD CONSTRAINT "levels_author_fkey" FOREIGN KEY ("author") REFERENCES "auth"."users"("id") ON UPDATE CASCADE ON DELETE CASCADE;
